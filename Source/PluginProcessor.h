...
/**
*/
class GainvstAudioProcessor  : public juce::AudioProcessor
{
public:
    //==============================================================================
    GainvstAudioProcessor();
    ~GainvstAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (GainvstAudioProcessor)
};
